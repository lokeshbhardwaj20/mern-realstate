      ...
      {listing && !loading && !error && (
        <div>
          ...
          <div className="flex flex-col max-w-4xl mx-auto p-3 gap-4">
              ...
              </p>
              {
                listing.offer && (
                  <p className="bg-green-900 w-full max-w-[200px] text-white text-center p-1 rounded-md">
                    <span>Discount -</span> ₹ {+listing.regularPrice - +listing.discountPrice}</p>
                )
              }
            ...
            <ul className="text-green-900 font-semi-bold text-sm flex flex-wrap items-center gap-4 sm:gap-6">
